 ...
 */
@Entity
@Table(name = "subskrypcjaulubionegosprzedawcy", schema = "", catalog = "esothebys_db")
public class SubskrypcjaulubionegosprzedawcyEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        SubskrypcjaulubionegosprzedawcyEntity that = (SubskrypcjaulubionegosprzedawcyEntity) o;
