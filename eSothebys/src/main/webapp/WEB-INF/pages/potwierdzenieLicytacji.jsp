...
<t:layout>
    ...
    <div>
        ...
        <form class="form-horizontal" action="${pageContext.request.contextPath}/" role="form" method="POST">
            <button style="width: 100px; margin-right: 20%" type="submit" class="btn btn-default pull-right">Licytuj
            </button>
        </form>
    </div>
</t:layout>
